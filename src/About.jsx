...
const About = ({ onClose = () => {} }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="fixed inset-0 z-50 flex items-center justify-center px-5 pb-20 md:px-10 md:pb-0">
        {/* Updated spacing with negative margin instead of padding */}
        <div
          className={`max-h-[85vh] w-full max-w-3xl transform overflow-y-auto rounded-lg bg-slate-50 p-8 text-left font-rocaTwoThin text-xl font-light transition-all duration-300 ease-in-out ${
